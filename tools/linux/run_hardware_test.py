...
def format_result_entry(arguments: argparse.Namespace,
    ...
    lines = [
        ...
        "#### Functional Test",
        "",
        f"**Exit code:** `{functional_code if functional else 'not run'}`  ",
        "",
        "```text",
        functional[1].rstrip() if functional else "Not run",
        "```",
        "",
        "#### Performance Test",
        "",
        f"**Exit code:** `{performance_code if performance else 'not run'}`  ",
        "",
        "```text",
        performance[1].rstrip() if performance else "Not run",
        "```",
        "",
        "---",
    ]
