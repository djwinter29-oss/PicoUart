...
/** @brief Vendor HID report descriptor used for status monitoring. */
...
static uint8_t const desc_configuration[] = {
    ...
    TUD_CDC_DESCRIPTOR(ITF_NUM_CDC0, STRID_CDC0, EPNUM_CDC0_NOTIF, 8, EPNUM_CDC0_OUT, EPNUM_CDC0_IN, 64),
    TUD_CDC_DESCRIPTOR(ITF_NUM_CDC1, STRID_CDC1, EPNUM_CDC1_NOTIF, 8, EPNUM_CDC1_OUT, EPNUM_CDC1_IN, 64),
    ...
    TUD_CDC_DESCRIPTOR(ITF_NUM_CDC4, STRID_CDC4, EPNUM_CDC4_NOTIF, 8, EPNUM_CDC4_OUT, EPNUM_CDC4_IN, 64),
    TUD_CDC_DESCRIPTOR(ITF_NUM_CDC5, STRID_CDC5, EPNUM_CDC5_NOTIF, 8, EPNUM_CDC5_OUT, EPNUM_CDC5_IN, 64),
