...
- Optional UART1 / UART4 loopbacks are tested individually; they are not part
  of this legacy concurrent fixture. The full HW1-to-PIO2 and PIO3-to-PIO4
  cross-fixture is documented in [Performance Test Plan](tests/performance-test-plan.md).
...
6. Run the concurrent performance benchmark when the 115200 baud tests pass.
  Use the legacy fixture shown above, or follow the full cross-fixture command
